...
namespace RestaurantNode.Api.Infrastructure.Migrations
{
    ...
    [Migration("20260924072232_AddGuestScopedPayments")]
    partial class AddGuestScopedPayments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantNode.Api.Domain.Payment", b =>
                {
                    ...
                    b.HasIndex("OrderId", "GuestNumber", "CreatedAt");

                    b.HasIndex("RestaurantId", "ShiftId", "CreatedAt");

                    b.ToTable("payments", (string)null);
                });

            modelBuilder.Entity("RestaurantNode.Api.Domain.PaymentRefund", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RestaurantNode.Api.Domain.Printer", b =>
                {
                    ...
                    b.HasIndex("HostDeviceId", "Address")
                        .IsUnique();
            ...
            modelBuilder.Entity("RestaurantNode.Api.Domain.PaymentRefund", b =>
                {
                    b.HasOne("RestaurantNode.Api.Domain.Payment", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RestaurantNode.Api.Domain.Printer", b =>
                {
                    b.HasOne("RestaurantNode.Api.Domain.Device", "HostDevice")
                        .WithMany()
