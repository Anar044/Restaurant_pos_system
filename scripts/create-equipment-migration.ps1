...
try {
    dotnet ef migrations add AddEquipmentAndPrinters --output-dir Infrastructure/Migrations
}
finally {
    Pop-Location
}

Write-Host "Equipment migration created. Review generated files, then commit them before running Restaurant Node."
