...
try {
    dotnet ef migrations add AddPosHostedWindowsPrinters --output-dir Infrastructure/Migrations
}
finally {
    Pop-Location
}

Write-Host "POS Agent printer migration created. Review generated files before running Restaurant Node."
