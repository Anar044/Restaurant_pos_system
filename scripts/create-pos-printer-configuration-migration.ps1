...
try {
    dotnet ef migrations add AddPosPrinterConfiguration --output-dir Infrastructure/Migrations
}
finally {
    Pop-Location
}

Write-Host "POS printer configuration migration created. Review it before running Restaurant Node."
